...
> @xpack/xpm-liquid@2.2.0 pretest-100-c8 /Users/ilg/My Files/WKS Projects/xpack.github/npm-packages/xpm-liquid-ts.git
> npm run lint

> @xpack/xpm-liquid@2.2.0 lint /Users/ilg/My Files/WKS Projects/xpack.github/npm-packages/xpm-liquid-ts.git
> ts-standard src && standard esm

> @xpack/xpm-liquid@2.2.0 test-100-c8 /Users/ilg/My Files/WKS Projects/xpack.github/npm-packages/xpm-liquid-ts.git
...
> @xpack/xpm-liquid@2.2.0 tap /Users/ilg/My Files/WKS Projects/xpack.github/npm-packages/xpm-liquid-ts.git
...
Determine the next version (like `2.2.0`),
and eventually update the
`package.json` file; the format is `2.2.0-pre`.
...
- `npm dist-tag add @xpack/xpm-liquid@2.2.0 latest`
- `npm dist-tag ls @xpack/xpm-liquid`
