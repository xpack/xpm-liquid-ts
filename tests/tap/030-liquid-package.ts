...
await test('constructor', async (t): Promise<void> => {
  ...
  t.ok(
    xpmLiquidPackage.topLiquidSubstitutionsVariables,
    'has topLiquidSubstitutionsVariables'
  )
  t.ok(
    xpmLiquidPackage.topLiquidSubstitutionsVariables.package,
    'has topLiquidSubstitutionsVariables.package'
  )
  t.equal(
    xpmLiquidPackage.topLiquidSubstitutionsVariables.package.version,
    '1.2.3',
    'package.version is 1.2.3'
  )

  t.ok(
    xpmLiquidPackage.topLiquidSubstitutionsVariables.properties,
    'has topLiquidSubstitutionsVariables.properties'
  )
  t.equal(
    xpmLiquidPackage.topLiquidSubstitutionsVariables.properties.one,
    '1',
    'properties.one is 1'
  )

  const topActions = xpmLiquidPackage.topActions
...
await test('actions', async (t): Promise<void> => {
  ...
  // console.log(xpmLiquidPackage)
  t.equal(
    xpmLiquidPackage.topLiquidSubstitutionsVariables.properties.p1,
    '1',
    'properties.p1 is 1'
  )
