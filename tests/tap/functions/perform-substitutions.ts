...
await t.test(
  'performSubstitutions - basic functionality',
...
await t.test(
  'performSubstitutions - filters cascade',
  async (t): Promise<void> => {
    const substitutionsVariables = {
      configuration: {
        name: 'Debug',
...
await t.test(
  'performSubstitutions - arrays original',
  async (t): Promise<void> => {
...
await t.test(
  'performSubstitutions - arrays multi',
  async (t): Promise<void> => {
    const substitutionsVariables = {
      map: {
        one: ['10', '11'],
...
await t.test(
  'performSubstitutions - assign context',
  async (t): Promise<void> => {
    const substitutionsVariables = {
      package: {
        properties2: {
...
await t.test(
  'performSubstitutions - error handling',
  async (t): Promise<void> => {
    const substitutionsVariables = {
      map: {
        one: '1',
