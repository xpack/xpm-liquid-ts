...
const config: Config = {
  ...
  projectName: 'xpm-lib-ts', // Usually your repo name.
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpm, xpack, liquid, typescript, nodejs, es6, module, library'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/xpack/xpm-lib-ts/',
          position: 'right',
        ...
        },
        {
          ...
          position: 'right',
          href: `https://www.npmjs.com/package/@xpack/xpm-lib/v/${customFields.releaseVersion}`,
        },
      ],
    },
    footer: {
      ...
      links: [
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack/xpm-lib-ts/discussions',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub xpm-lib-ts project',
              href: 'https://github.com/xpack/xpm-lib-ts/',
            },
            {
