...
slug: /api/xpm-lib/classes/xpmliquidbuildconfigurations/_expandtemplatebuildconfigurations
title: XpmLiquidBuildConfigurations._expandTemplateBuildConfigurations() method
...
Promise&lt;Map&lt;string, [XpmLiquidBuildConfiguration](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidbuildconfiguration)<!-- -->&gt;&gt;

A promise that resolves to a map of expanded configuration names to their corresponding instances.

## Exceptions

[XpmError](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmerror) If the matrix structure is invalid or substitution fails.
