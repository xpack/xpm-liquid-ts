...
slug: /api/xpm-lib/classes/xpmliquidbuildconfigurations/_buildcomfigurationsnamesset
title: XpmLiquidBuildConfigurations._buildComfigurationsNamesSet property
...
Detection occurs during [XpmLiquidBuildConfigurations.initialise()](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidbuildconfigurations/initialise)<!-- -->, throwing [XpmError](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmerror) when duplicates are found to ensure configuration name uniqueness.
