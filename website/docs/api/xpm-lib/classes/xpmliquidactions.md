...
slug: /api/xpm-lib/classes/xpmliquidactions
title: XpmLiquidActions class
...
[(constructor)({ log, engine, substitutionsVariables, inheritedActionsMap, jsonActions, buildConfiguration, })](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/constructor)
...
[\_actionsMap](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/_actionsmap)
...
Map&lt;string, [XpmLiquidAction](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidaction) \| undefined&gt;
...
[\_actionsNamesSet](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/_actionsnamesset)
...
[\_isInitialised](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/_isinitialised)
...
[\_jsonActionsNamesMap](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/_jsonactionsnamesmap)
...
[buildConfiguration](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/buildconfiguration)
...
[XpmLiquidBuildConfiguration](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidbuildconfiguration) \| undefined
...
[engine](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/engine)
...
[jsonActions](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/jsonactions)
...
[log](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/log)
...
[substitutionsVariables](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/substitutionsvariables)
...
[\_expandTemplateActions({ actionName, jsonActionTemplate, })](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/_expandtemplateactions)
...
[empty()](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/empty)
...
[get(actionName)](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/get)
...
[has(actionName)](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/has)
...
[initialise()](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/initialise)
...
[names()](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidactions/names)
