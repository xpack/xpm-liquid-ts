...
slug: /api/xpm-lib/classes/liquidpropertiesdrop
title: LiquidPropertiesDrop class
...
Implements the Liquid Drop pattern to provide lazy property resolution and recursive template evaluation. When a template accesses `properties.foo`<!-- -->, the Liquid engine calls [LiquidPropertiesDrop.liquidMethodMissing()](/xpm-lib-ts/docs/api/xpm-lib/classes/liquidpropertiesdrop/liquidmethodmissing) which:
...
[(constructor)({ engine, properties, log, }, input)](/xpm-lib-ts/docs/api/xpm-lib/classes/liquidpropertiesdrop/constructor)
...
[\_engine](/xpm-lib-ts/docs/api/xpm-lib/classes/liquidpropertiesdrop/_engine)
...
[\_log](/xpm-lib-ts/docs/api/xpm-lib/classes/liquidpropertiesdrop/_log)
...
[\_properties](/xpm-lib-ts/docs/api/xpm-lib/classes/liquidpropertiesdrop/_properties)
...
[liquidMethodMissing(key, context)](/xpm-lib-ts/docs/api/xpm-lib/classes/liquidpropertiesdrop/liquidmethodmissing)
