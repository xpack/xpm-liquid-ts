...
slug: /api/xpm-lib/classes/xpmbuildconfiguration/_isinitialised
title: XpmBuildConfiguration._isInitialised property
...
This flag ensures idempotent initialization and prevents redundant processing when [XpmBuildConfiguration.initialise()](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmbuildconfiguration/initialise) is called multiple times.
