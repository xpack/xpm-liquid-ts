...
slug: /api/xpm-lib/classes/xpmactions/_processtemplate
title: XpmActions._processTemplate() method
...
[XpmError](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmerror) If duplicate action names are detected during expansion or if template expansion fails.
