...
slug: /api/xpm-lib/classes/xpmactions/_createsubstitutedaction
title: XpmActions._createSubstitutedAction() method
...
{ combination: Record&lt;string, string&gt;; actionName: string; jsonAction: [JsonActionContent](/xpm-lib-ts/docs/api/xpm-lib/typealiases/jsonactioncontent)<!-- -->; newActionsMap: Map&lt;string, [XpmAction](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmaction)<!-- -->&gt;; }
...
[XpmError](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmerror) If the action name substitution fails.
