...
3. Checked at the start of [XpmLiquidBuildConfiguration.initialise()](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmliquidbuildconfiguration/initialise) to return early if already initialised.
