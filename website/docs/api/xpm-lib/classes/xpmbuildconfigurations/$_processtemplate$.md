...
slug: /api/xpm-lib/classes/xpmbuildconfigurations/_processtemplate
title: XpmBuildConfigurations._processTemplate() method
...
[XpmError](/xpm-lib-ts/docs/api/xpm-lib/classes/xpmerror) If duplicate configuration names are detected during expansion or if template expansion fails.
