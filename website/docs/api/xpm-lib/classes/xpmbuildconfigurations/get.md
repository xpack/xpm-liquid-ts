...
slug: /api/xpm-lib/classes/xpmbuildconfigurations/get
title: XpmBuildConfigurations.get() method
...
[XpmInputError](/xpm-lib-ts/docs/api/xpm-lib/classes/xpminputerror) If a configuration with the specified name does not exist.
