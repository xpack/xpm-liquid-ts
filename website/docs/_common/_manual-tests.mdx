...
```sh
npm --prefix ~/Work/xpack/xpm-lib-ts.git/tests install
xpm run deep-clean -C ~/Work/xpack/xpm-lib-ts.git/tests
```
...
```sh
xpm run install -C ~/Work/xpack/xpm-lib-ts.git/tests
xpm run test -C ~/Work/xpack/xpm-lib-ts.git/tests
```

To execute a selection of tests with the latest versions of toolchains:

```sh
xpm run install-selected -C ~/Work/xpack/xpm-lib-ts.git/tests
xpm run test-selected -C ~/Work/xpack/xpm-lib-ts.git/tests
```

To execute all tests with the latest versions of toolchains:

```sh
xpm run install-latest -C ~/Work/xpack/xpm-lib-ts.git/tests
xpm run test-latest -C ~/Work/xpack/xpm-lib-ts.git/tests
```

To execute all tests with all toolchain versions:

```sh
xpm run install-all -C ~/Work/xpack/xpm-lib-ts.git/tests
xpm run test-all -C ~/Work/xpack/xpm-lib-ts.git/tests
```
