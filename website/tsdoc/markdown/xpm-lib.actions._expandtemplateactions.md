...
This method uses the [TemplateExpander](./xpm-lib.templateexpander.md) to compute the Cartesian product of all matrix parameter values and creates a separate action for each combination, substituting matrix values into both the action name and command templates.
