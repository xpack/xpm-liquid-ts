...
[Home](./index.md) &gt; [@xpack/xpm-lib](./xpm-lib.md) &gt; [InitTemplateBase](./xpm-lib.inittemplatebase.md) &gt; [render](./xpm-lib.inittemplatebase.render.md)
...
{ sourceFilePath: string; destinationFilePath: string; substitutionsVariables?: [InitTemplateSubstitutionsVariables](./xpm-lib.inittemplatesubstitutionsvariables.md)<!-- -->; }
...
[OutputError](./xpm-lib.outputerror.md) If template rendering fails.
