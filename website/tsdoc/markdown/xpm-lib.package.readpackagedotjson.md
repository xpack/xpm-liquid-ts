...
[Home](./index.md) &gt; [@xpack/xpm-lib](./xpm-lib.md) &gt; [Package](./xpm-lib.package.md) &gt; [readPackageDotJson](./xpm-lib.package.readpackagedotjson.md)
...
[InputError](./xpm-lib.inputerror.md) If `package.json` is missing or invalid and `withThrow` is true.
...
When `withThrow` is false, the method returns undefined for missing or invalid files, allowing callers to handle the absence gracefully. When `withThrow` is true, errors are thrown as [InputError](./xpm-lib.inputerror.md) for consistent error handling across the application.
