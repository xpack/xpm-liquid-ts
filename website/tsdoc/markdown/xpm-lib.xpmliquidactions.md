...
[Home](./index.md) &gt; [@xpack/xpm-lib](./xpm-lib.md) &gt; [XpmLiquidActions](./xpm-lib.xpmliquidactions.md)

## XpmLiquidActions class
...
[(constructor)({ log, engine, substitutionsVariables, inheritedActionsMap, jsonActions, buildConfiguration, })](./xpm-lib.xpmliquidactions._constructor_.md)
...
[\_actionsMap](./xpm-lib.xpmliquidactions._actionsmap.md)
...
Map&lt;string, [XpmLiquidAction](./xpm-lib.xpmliquidaction.md) \| undefined&gt;
...
[\_actionsNamesSet](./xpm-lib.xpmliquidactions._actionsnamesset.md)
...
[\_isInitialised](./xpm-lib.xpmliquidactions._isinitialised.md)
...
[\_jsonActionsNamesMap](./xpm-lib.xpmliquidactions._jsonactionsnamesmap.md)
...
[buildConfiguration](./xpm-lib.xpmliquidactions.buildconfiguration.md)
...
[XpmLiquidBuildConfiguration](./xpm-lib.xpmliquidbuildconfiguration.md) \| undefined
...
[engine](./xpm-lib.xpmliquidactions.engine.md)
...
[jsonActions](./xpm-lib.xpmliquidactions.jsonactions.md)
...
[log](./xpm-lib.xpmliquidactions.log.md)
...
[substitutionsVariables](./xpm-lib.xpmliquidactions.substitutionsvariables.md)
...
[\_expandTemplateActions({ actionName, jsonActionTemplate, })](./xpm-lib.xpmliquidactions._expandtemplateactions.md)
...
[empty()](./xpm-lib.xpmliquidactions.empty.md)
...
[get(actionName)](./xpm-lib.xpmliquidactions.get.md)
...
[has(actionName)](./xpm-lib.xpmliquidactions.has.md)
...
[initialise()](./xpm-lib.xpmliquidactions.initialise.md)
...
[names()](./xpm-lib.xpmliquidactions.names.md)
