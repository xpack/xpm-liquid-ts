...
[Home](./index.md) &gt; [@xpack/xpm-lib](./xpm-lib.md) &gt; [XpmLiquidBuildConfigurations](./xpm-lib.xpmliquidbuildconfigurations.md) &gt; [\_expandTemplateBuildConfigurations](./xpm-lib.xpmliquidbuildconfigurations._expandtemplatebuildconfigurations.md)

## XpmLiquidBuildConfigurations.\_expandTemplateBuildConfigurations() method
...
Promise&lt;Map&lt;string, [XpmLiquidBuildConfiguration](./xpm-lib.xpmliquidbuildconfiguration.md)<!-- -->&gt;&gt;

A promise that resolves to a map of expanded configuration names to their corresponding instances.

## Exceptions

[XpmError](./xpm-lib.xpmerror.md) If the matrix structure is invalid or substitution fails.
